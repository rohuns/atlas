...
file_cascade_2 <- "~/Desktop/231N/cascadelosslog.txt" # Loss using weights 1000 
# and 100
file_cascade_pt1 <- "~/Desktop/231N/cascadeonelog.txt"
overfit_cascade_1 <- "~/final-proj-atlas/experiments/test_cascade_2/log.txt" # 1000
overfit_cascade_2 <- "~/final-proj-atlas/experiments/test_cascade_3/log.txt" #100
overfit_cascade_3 <- "~/final-proj-atlas/experiments/test_cascade_4/log.txt" #10

cascade_full <- "~/Desktop/231N/cascadetwolog.txt"
# ==============================================================================
```
